...
class ToolCardsGenerator {
  ...
  async generateToolCards() {
    console.log('🎯 Generating AI Tool Cards with Real Websites...');
    
    await fs.ensureDir(this.contentDir);

    // Define real AI tools by category with REAL websites
    const realToolsData = {
      'Writing & Content': [
        {
          name: 'ChatGPT',
      ...
      'Development': [
        ...
        },
        {
          ...
          pricing: 'Freemium',
          pricingDetails: 'Free plan available, Pro at $20/month',
          features: ['AI code generation', 'Natural language editing', 'Codebase chat', 'Privacy mode', 'VS Code compatibility'],
          tags: ['code editor', 'ai coding', 'pair programming', 'productivity'],
          rating: 4.6,
          reviewCount: 5670,
          verified: true,
          featured: false
        ...
        },
        {
          ...
          description: 'Amazon\'s AI coding companion for faster development',
          pricing: 'Freemium',
          pricingDetails: 'Free tier available, Professional at $19/month',
          features: ['Code suggestions', 'Security scanning', 'Reference tracking', 'Multi-language support', 'AWS integration'],
          tags: ['aws', 'code completion', 'security', 'enterprise'],
          rating: 4.4,
          reviewCount: 4230,
          verified: true,
          featured: false
        },
        {
          ...
          pricing: 'Freemium',
          pricingDetails: 'Free for individuals, Pro at $9/month',
          features: ['Codebase understanding', 'Code explanation', 'Bug fixing', 'Test generation', 'Refactoring'],
          tags: ['codebase analysis', 'ai assistant', 'debugging', 'testing'],
          rating: 4.5,
          reviewCount: 3890,
          verified: true,
          featured: false
      ...
      'Marketing': [
        ...
        },
        {
          ...
          description: 'AI-powered email marketing and customer data platform',
          pricing: 'Freemium',
          pricingDetails: 'Free plan available, paid plans from $20/month',
          features: ['Email automation', 'SMS marketing', 'Customer segmentation', 'Predictive analytics', 'A/B testing'],
          tags: ['email marketing', 'sms', 'automation', 'analytics'],
          rating: 4.5,
          reviewCount: 6780,
          verified: true,
          featured: false
        },
        {
          ...
          description: 'Enterprise marketing automation with AI-driven insights',
          pricing: 'Enterprise',
          pricingDetails: 'Custom pricing for enterprise customers',
          features: ['Lead management', 'Marketing automation', 'Account-based marketing', 'Revenue attribution', 'AI insights'],
          tags: ['enterprise', 'automation', 'lead management', 'abm'],
          rating: 4.3,
          reviewCount: 5430,
          verified: true,
          featured: false
      ...
      'Analytics': [
        ...
        },
        {
          ...
          description: 'Google Cloud\'s business intelligence and data platform',
          pricing: 'Enterprise',
          pricingDetails: 'Custom pricing, part of Google Cloud',
          features: ['Data modeling', 'Real-time dashboards', 'Embedded analytics', 'Data governance', 'Machine learning'],
          tags: ['google cloud', 'business intelligence', 'data modeling', 'enterprise'],
          rating: 4.4,
          reviewCount: 4890,
          verified: true,
          featured: false
        },
        {
          ...
          description: 'Microsoft\'s business analytics solution with AI capabilities',
          pricing: 'Freemium',
          pricingDetails: 'Free version available, Pro at $10/month per user',
          features: ['Data visualization', 'AI insights', 'Natural language queries', 'Real-time dashboards', 'Microsoft integration'],
          tags: ['microsoft', 'business intelligence', 'data visualization', 'ai insights'],
          rating: 4.4,
          reviewCount: 12340,
          verified: true,
          featured: false
      ...
      'Video & Media': [
        ...
        },
        {
          ...
          description: 'AI-powered video creation from text and articles',
          pricing: 'Paid',
          pricingDetails: 'Plans start at $19/month',
          features: ['Text-to-video', 'Article to video', 'Auto captions', 'Video highlights', 'Brand customization'],
          tags: ['text-to-video', 'content creation', 'auto captions', 'marketing'],
          rating: 4.4,
          reviewCount: 3780,
          verified: true,
          featured: false
        },
        {
          ...
          pricing: 'Freemium',
          pricingDetails: 'Free plan available, Business at $15/month',
          features: ['Video templates', 'AI script generation', 'Text-to-video', 'Brand kit', 'Collaboration tools'],
          tags: ['video creation', 'templates', 'ai script', 'collaboration'],
          rating: 4.5,
          reviewCount: 6890,
          verified: true,
          featured: false
      ...
      'Business': [
        ...
        },
        {
          ...
          pricing: 'Freemium',
          pricingDetails: 'Free plan available, Standard at $5/month per user',
          features: ['Kanban boards', 'Automation rules', 'Team collaboration', 'Calendar view', 'Power-ups'],
          tags: ['project management', 'kanban', 'automation', 'collaboration'],
          rating: 4.5,
          reviewCount: 14560,
          verified: true,
          featured: false
        },
        {
          ...
          pricing: 'Freemium',
          pricingDetails: 'Free plan available, Unlimited at $7/month per user',
          features: ['Task management', 'AI writing assistant', 'Time tracking', 'Goal tracking', 'Custom workflows'],
          tags: ['productivity', 'task management', 'ai writing', 'workflows'],
          rating: 4.6,
          reviewCount: 11230,
          verified: true,
          featured: false
    ...
    for (const [categoryName, tools] of Object.entries(realToolsData)) {
      console.log(`📦 Processing ${categoryName} - ${tools.length} tools`);
      
      for (const tool of tools) {
        // Generate enhanced description using DeepSeek API
        const longDescription = await this.generateLongDescription(tool.name, tool.description);
    ...
    const categories = Object.keys(realToolsData).map((categoryName, index) => ({
      id: (index + 1).toString(),
      name: categoryName,
      slug: slugify(categoryName, { lower: true, strict: true }),
      description: this.getCategoryDescription(categoryName),
      icon: this.getCategoryIcon(categoryName),
      toolCount: realToolsData[categoryName].length,
      featured: true
    }));
    ...
    await fs.writeJSON(path.join(this.contentDir, 'tool-cards.json'), allTools, { spaces: 2 });
    ...
    console.log(`   📦 ${allTools.length} real AI tool cards`);
    console.log(`   📂 ${categories.length} categories`);
    console.log(`   ⚙️ Site configuration`);
    console.log(`\n📁 Files created:`);
    console.log(`   - content/tool-cards.json (MAIN TOOL CARDS)`);
...
async function main() {
  const generator = new ToolCardsGenerator();
  await generator.generateToolCards();
}
...
module.exports = { ToolCardsGenerator };