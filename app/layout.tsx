    ...
    <html lang="en">
      <head>
        ...
        <script
          ...
          data-cfasync="false"
          async
          onError="() => console.log('Monetag error')"
          onLoad="() => console.log('Monetag loaded')"
        />
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `
              window._lvtopv = function() { console.log('Monetag push notification error'); };
              window._lytby = function() { console.log('Monetag push notification ready'); };
            `
          }}
        />
